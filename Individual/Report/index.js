            ...
            <div className={cx('content-wrapper')}>
                {chosen !== '' && (
                    <>
                        ...
                        <p>Số điểm</p>
                        <p className={cx('content')}>{questions[chosen].difficulty}</p>
                        <p>Vòng thi</p>
                        <p className={cx('content')}>{questions[chosen].type}</p> */}
                        <p>Báo cáo</p>
                        <p className={cx('content')}>{questions[chosen].report}</p>
